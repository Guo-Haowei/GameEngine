...
void PropertyPanel::UpdateInternal(Scene& p_scene) {
    ...
    DrawComponent("Object", object_component, [&](ObjectComponent& p_object) {
        ...
        ImGui::Checkbox("Cast shadow", &cast_shadow);
        p_object.flags = (hide ? ObjectComponent::FLAG_NONE : ObjectComponent::FLAG_RENDERABLE);
        p_object.flags |= (cast_shadow ? ObjectComponent::FLAG_CAST_SHADOW : ObjectComponent::FLAG_NONE);
    });
