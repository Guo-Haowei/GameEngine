...
void main() {
    ...
    Vector4f origin = c_viewMatrix * Vector4f(texture(t_GbufferPositionMap, uv).xyz, 1.0f);
    ...
    for (int i = 0; i < SSAO_KERNEL_SIZE; ++i) {
        ...
        Vector4f offsetPos = c_viewMatrix * Vector4f(texture(t_GbufferPositionMap, offset.xy).xyz, 1.0f);
