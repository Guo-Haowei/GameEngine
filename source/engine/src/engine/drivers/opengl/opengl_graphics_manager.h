...
public:
    ...
    void setRenderTarget(const DrawPass* p_subpass, int p_index, int p_mip_level) final;
    void unsetRenderTarget() final;

    void clear(const DrawPass* p_subpass, uint32_t p_flags, float* p_clear_color) final;
